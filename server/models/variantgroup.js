...
const schema = new mongoose.Schema(
  {
    name: {
      ...
      maxlength: [100, 'Variant Group Name cannot be more than 100 characters long'],
    },
    slug: {
      type: String,
      unique: true,
    ...
    // terms: [{ type: mongoose.Schema.Types.ObjectId, ref: 'AttributeTerms' }],
  },
...
export default mongoose.model('VariantGroup', schema);
