...
<template>
  <div class="product-details">
    ...
    <div class="columns">
      ...
      <div class="center">
        <div class="test" style="width: 100%; height: 10rem">
          <FormsBaseSelect
            label="Color"
            :options="[
              { key: 1, name: 'Onewqwqx dfdfds sdffdsfdsfsd dfsdfssdf dsfsdfsd sdffsdd sdfsdf ' },
              { key: 2, name: 'Two' },
            ]"
          />
        </div>

        <div class="test" style="width: 60rem">
          <FormsBaseInput label="Test" placeholder="Test" />
        </div>
